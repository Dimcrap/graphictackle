...
if(!gladLoadGLLoader((GLADloadproc)glfwGetProcAddress)){
    ...
    float camX {0},camZ{0},currentframe{0};
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        //view = glm::lookAt(glm::vec3(camX,5.0f,camZ),glm::vec3(0.0f,0.0f,0.0f),
        //glm::vec3(0.0f,1.0f,0.0f));
        glm::mat4 projection{glm::perspectiveRH(glm::radians(fov), 800.0f/600.0f, 0.1f, 
        100.0f)};
